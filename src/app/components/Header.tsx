...
export default function Header() {
  ...
  return (
    <header className="Header">
      <div className="d-f jc-c g-8">
        <button className="app-button" onClick={toggleGap}>
          <svg xmlns="http://www.w3.org/2000/svg" width="32" height="24" strokeWidth=".75" viewBox="0 0 16 16" fill="none">
            <rect x="1.5" y="1.5" width="13" height="13" rx="1.5" stroke="black"/>
            <rect x="4.5" y="4.5" width="7" height="7" rx="0.5" stroke="black"/>
          </svg>
        </button>
        <button className="app-button" onClick={toggleBlur}>
          <svg width="32" height="24" strokeWidth=".75" viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <button className="app-button" onClick={toggleGrayScale}>
          <svg xmlns="http://www.w3.org/2000/svg" width="32" height="24" strokeWidth=".75" viewBox="0 0 16 16" fill="none">
            <circle cx="8" cy="8" r="6.5" stroke="black"/>
            <path d="M7.5 2H8.5V14H7.5L7.5 2Z" fill="black"/>
            <path d="M12.3033 2.98959L13.0104 3.6967L3.81803 12.8891L3.11093 12.182L12.3033 2.98959Z" fill="black"/>
            <path d="M2.98959 3.69669L3.6967 2.98958L12.8891 12.182L12.182 12.8891L2.98959 3.69669Z" fill="black"/>
            <path d="M2 8.5L2 7.5L14 7.5L14 8.5L2 8.5Z" fill="black"/>
          </svg>
        </button>
        <button className="app-button" onClick={toggleLightMode}>
          <svg xmlns="http://www.w3.org/2000/svg" width="32" height="24" strokeWidth=".75" viewBox="0 0 16 16" fill="none">
            <path d="M10.5 8C10.5 9.38071 9.38071 10.5 8 10.5C6.61929 10.5 5.5 9.38071 5.5 8C5.5 6.61929 6.61929 5.5 8 5.5C9.38071 5.5 10.5 6.61929 10.5 8Z" stroke="#161616"/>
            <path d="M8 1.5V3.5" stroke="#161616" strokeLinecap="round"/>
            <path d="M8 12.5V14.5" stroke="#161616" strokeLinecap="round"/>
            <path d="M1.5 8H3.5" stroke="#161616" strokeLinecap="round"/>
            <path d="M12.5 8H14.5" stroke="#161616" strokeLinecap="round"/>
            <path d="M3.5 3.5L4.5 4.5" stroke="#161616" strokeLinecap="round"/>
            <path d="M12.5 3.5L11.5 4.5" stroke="#161616" strokeLinecap="round"/>
            <path d="M3.5 12.5L4.5 11.5" stroke="#161616" strokeLinecap="round"/>
            <path d="M12.5 12.5L11.5 11.5" stroke="#161616" strokeLinecap="round"/>
          </svg>
        </button>
      </div>
    </header>
